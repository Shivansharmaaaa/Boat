...
const Tabfour = () => {
  ...
  <Flex p={5}>
      <Box position="relative" p={4} borderRadius="xl" mr={4} width="25%" textAlign="center">
        <Image src="/SmartWatch1.jpeg" alt="Image 1" width="100%" borderTopRadius={14} />
      ...
      <Box position="relative" p={4} borderRadius="xl" mr={4} width="25%" textAlign="center">
        <Image src="/SmartWatch2.jpeg" alt="Image 2" width="100%" borderTopRadius={14} />
        <Box position="absolute" bottom={0} left={0} right={0} bg="white" p={2}>
      ...
      <Box position="relative" p={4} borderRadius="xl" mr={4} width="25%" textAlign="center">
        <Image src="/SmartWatch3.jpeg" alt="Image 1" width="100%" borderTopRadius={14} />
        <Box position="absolute" bottom={0} left={0} right={0} bg="white" p={2} >
          <Text>Nirvana Ion</Text>
          <del>$50.00</del> $30.00
          <Box bgColor="black" color="white" p={2} mt={2} >
      ...
      <Box position="relative" p={4} borderRadius="xl" mr={4} width="25%" textAlign="center">
        <Image src="/SmartWatch4.jpeg" alt="Image 2" width="100%" borderTopRadius={14} />
        <Box position="absolute" bottom={0} left={0} right={0} bg="white" p={2}>
          <Text>Product Name 2</Text>
          <del>$60.00</del> $40.00
          <Box bgColor="black" color="white" p={2} mt={2}>
